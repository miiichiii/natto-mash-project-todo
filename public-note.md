...
- 2026-06-15: LipoSEARCH and serum cytokine sample-selection policy was fixed at a small, balanced mechanistic subset. One natto-treated non-protected / non-responder candidate is retained for exploratory comparison.
...
Note: Raw animal IDs, exact unpublished values, sample storage details, internal budgets, local file paths, and private contact details are intentionally excluded from this public note.
